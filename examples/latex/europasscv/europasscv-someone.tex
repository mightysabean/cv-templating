...
% BEGIN_FOLD ((( section.company|escape_tex )))
		...
		\ecvitem{Main projects}{}
			...
			((* endfor *))
		((* endif *))
% END_FOLD ((( section.company|escape_tex )))
...
% BEGIN_FOLD Education and training
	...
	((* if acadinfo.acadmain is defined *))
		((* for section in acadinfo.acadmain *))
			...
			((* if section.notes.tex is defined *))
...
\begin{figure}
	...
	\begin{tabular}{p{0.5\textwidth} p{0.5\textwidth}}
		\toprule
		\raisebox{-\totalheight}{
			\includegraphics[width=0.5\textwidth]{(((- figures_directory -)))/Computing.pdf}} &
		\raisebox{-\totalheight}{
			\includegraphics[width=0.5\textwidth]{(((- figures_directory -)))/Data.pdf}} \\
...
\begin{tabular}{p{0.5\textwidth} p{0.5\textwidth}}
	...
	\raisebox{-\totalheight}{
		\includegraphics[width=0.5\textwidth]{(((- figures_directory -)))/Systems.pdf}} 	&
	
	\raisebox{-\totalheight}{
		\includegraphics[width=0.5\textwidth]{(((- figures_directory -)))/Office tools.pdf}}  \\
	\raisebox{-\totalheight}{
		\includegraphics[width=0.5\textwidth]{(((- figures_directory -)))/Professional.pdf}} &
	\raisebox{-\totalheight}{
		\includegraphics[width=0.5\textwidth]{(((- figures_directory -)))/Management and communication.pdf}} 	
...
\end{figure}
\end{europasscv}
% TODO Links a Documentos en otras lenguas
% TODO links a certificados
\end{document}
